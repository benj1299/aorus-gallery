...
export default async function AdminArtistsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <AdminSearch items={artists} searchKeys={['name' as keyof typeof artists[0]]} placeholder="Rechercher un artiste...">
        {(filtered) => (
                ...
                {filtered.length === 0 && (
                  <TableRow>
                    <TableCell colSpan={5} className="h-24 text-center text-muted-foreground">
                      Aucun artiste pour le moment. <Link href="/admin/artists/new" className="underline">Cr\u00e9ez le premier</Link>.
                    </TableCell>
                  </TableRow>
                )}
              </TableBody>
